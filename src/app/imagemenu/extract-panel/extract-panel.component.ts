...
import { ExtractDataService } from "src/app/embed-extract-data/extract-data.service";
...
@Component({
	selector: "extract-panel",
	templateUrl: "./extract-panel.component.html",
})
export class ExtractPanelComponent implements OnInit {
	constructor(
